...
knit("~/Desktop/Machine Learning and Data Modelling/Course Work/B00897178.R", output = "~/Desktop/Machine Learning and Data Modelling/Course Work/B00897178.html")
